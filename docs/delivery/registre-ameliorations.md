...
| POL-062 | P2 | Le cycle s'arrête à l'achat. Réception, mise en vente et vente ont leurs tables (`sale_listings`, `sales`) et leurs statuts, mais aucun cas d'usage : `listed_for_sale` se change encore sans écrire d'annonce, et `sold` reste inatteignable. |
