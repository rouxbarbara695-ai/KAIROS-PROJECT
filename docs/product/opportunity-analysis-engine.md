...
Kairos does not automatically scan the entire market in V1.

The user manually selects potentially interesting listings, while Kairos automates all subsequent data collection and analysis.
...
Full automation is therefore an evolution of the V1 architecture, not a prerequisite.
